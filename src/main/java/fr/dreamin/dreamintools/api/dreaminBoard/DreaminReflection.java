...
public final class DreaminReflection {
  ...
  public static DreaminReflection.PacketConstructor findPacketConstructor(Class<?> packetClass, MethodHandles.Lookup lookup) throws Exception {
    try {
    ...
    if (theUnsafe == null) {
      synchronized (DreaminReflection.class) {
        if (theUnsafe == null) {
